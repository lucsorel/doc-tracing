...
== Fouiller une base de code fossile par tracage
...
[.medium-text]
*Luc Sorel-Giffo* -- jeudi 29 juin 2023 -- BreizhCamp
...
=== Code-as-doc&ensp;-&ensp;analyse statique de code
...
* génération / mise à jour à partir d'une source de vérité
...
Rôle : l'exécution du code (script, fonction) doit-elle être tracée ?
...
Rôle : poursuivre le traçage après chaque expression ou une levée d'erreur ?
...
[.medium-text]
💡 créer `error_tracer` avec un pattern _factory_.
...
=== pydoctrace : factorial reduce, erreur bien geree 👍
...
Documenter la vraie vie

* les tests fonctionnels associés à une _user story_
* le code d'une base qu'on découvre

[.medium-text]
À vos issues et vos ⭐ sur https://github.com/lucsorel/pydoctrace[github.com/lucsorel/pydoctrace]
